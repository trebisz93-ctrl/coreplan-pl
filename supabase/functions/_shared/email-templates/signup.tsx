...
export const SignupEmail = ({
  ...
  <Html lang="pl" dir="ltr">
    ...
    <Preview>Potwierdź swój adres e-mail — CorePlan</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            ...
            ! Aby aktywować konto, potwierdź swój adres e-mail:
          </Text>
          ...
          <Text style={hint}>
            Link wygaśnie za 24 godziny. Jeśli nie zakładałeś konta
            w CorePlan, zignoruj tę wiadomość.
          </Text>
        </Section>
